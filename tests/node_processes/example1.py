...
@node_process(requires=['extract01'])
def transform01():
    print('executing transform01...')


@node_process(requires=['extract01', 'extract02'])
def transform02():
    print('executing transform02...')


@node_process(requires=['extract02'])
def transform03():
    print('executing transform03...')


@node_process(requires=['transform01'])
def load1():
    print('executing load1...')


@node_process(requires=['transform02'])
def load2():
...
@node_process(requires=['transform03'])
def load4():
